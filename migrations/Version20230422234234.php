 ...
 */
final class Version20230422234234 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__i23_paniers AS SELECT id FROM i23_paniers');
        $this->addSql('DROP TABLE i23_paniers');
        $this->addSql('CREATE TABLE i23_paniers (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_utilisateur INTEGER DEFAULT NULL, CONSTRAINT FK_6257196150EAE44 FOREIGN KEY (id_utilisateur) REFERENCES i23_utilisateurs (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO i23_paniers (id) SELECT id FROM __temp__i23_paniers');
        $this->addSql('DROP TABLE __temp__i23_paniers');
